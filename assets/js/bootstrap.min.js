...
!(function(t, e) {
    ...
    g(document)
        .on(j.CLICK_DATA_API, w, function(t) {
            var e = t.target;
            if (
                (g(e).hasClass(D) || (e = g(e).closest(L)[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))
            )
                t.preventDefault();
            else {
        ...
        g(window).on(j.LOAD_DATA_API, function() {
            ...
            for (
                var r = 0, s = (t = [].slice.call(document.querySelectorAll(N))).length; r < s; r++
            ) {
                var a = t[r];
        ...
        ut = (function() {
            ...
            return (
                ...
                (t._getItemIndex = function(t) {
                    return (
                        (this._items =
                            t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(ot)) : []),
                ...
                (c._dataApiKeydownHandler = function(t) {
                    if (
                        (/input|textarea/i.test(t.target.tagName) ?
                            ...
                            Lt.test(t.which)) &&
                        (t.preventDefault(),
                            t.stopPropagation(), !this.disabled && !g(this).hasClass(Ht))
                    ) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ((this._backdrop = document.createElement("div")),
                                ...
                                g(this._backdrop).addClass(ge), !t)
                        )
                            return;
                        if (!n) return void t();
    ...
    g(window).on(pn.LOAD_DATA_API, function() {
            for (
                var t = [].slice.call(document.querySelectorAll(En)), e = t.length; e--;
